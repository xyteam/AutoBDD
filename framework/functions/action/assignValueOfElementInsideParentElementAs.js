...
module.exports = (targetElementIndex, targetElement, parentElementIndex, parentElement, varName) => {
    ...
    process.env[varName] = retrivedValue;
    console.log(`assigned "${process.env[varName]}" to process.env.${varName}`);
};
