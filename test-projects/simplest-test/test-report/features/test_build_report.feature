...
Feature: test build report
  ...
  Scenario: download drivers
    When  I open the file "~/Projects/AutoBDD/test-projects/simplest-test/bdd_reports/build-test/index.html"
    Then  I expect that the title is "Multiple Cucumber HTML Reporter"
